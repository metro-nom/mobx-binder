...
import SrcLink from '../../../components/SrcLink.astro'
...
<p>A <SrcLink to="mobx-binder-core/src/model/binder/Binder.ts">Binder</SrcLink> manages form state for a set of fields represented by "dumb" observable field instances implementing the <SrcLink to="mobx-binder-core/src/model/fields/FieldStore.ts">FieldStore</SrcLink> interface. It is configured via a fluent api like this:</p>
...
-   Load initial values via simple object properties (see [Loading and storing field values](usage/load-store))

<p>A simple <SrcLink to="sample/src/app/forms/FormField.tsx">example</SrcLink> of how to render such fields can be found in the <SrcLink to="sample">sample code</SrcLink>.</p>
