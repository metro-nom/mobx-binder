...
DefaultBinder
The *DefaultBinder* already makes assumptions about the translation library, which should support ES2015 templating style keys and named arguments, like [i18n-harmony](https://www.npmjs.com/package/i18n-harmony). For that scenario, it already provides a set of ready-to-use Validators and Converters. All this is part of the *mobx-binder* module.
