...
Since version 1.4, the backend representation is also checked for equality in case the current value is valid. Changes that lead to the same valid backend representation are treated as unchanged.
